...
@section('content')
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden sm:rounded-lg object-center" id="demographics-container">

                    <div id="interest-section">
                        
                        <form id="interest-selection">
                            <p>Are you interested in the Health Equity Thermometer and Screening tool as part of your work?</p>
