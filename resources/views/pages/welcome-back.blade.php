...
<div id="welcome-back-container">
    ...
    <div class="container-header">Welcome back to the Health Equity Thermometer and Screening Tool! What would you like to do today?</div>
    ...
    <div id="information-button-container" class="button-container">
        ...
        <button id="start-new-button" class="button">Start a new session of the screening tool</button>
        <button id="download-thermometer" class="button">Download a copy of the thermometer</button>
    </div>
